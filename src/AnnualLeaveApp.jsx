...
const PrintApplicationModal = ({ record, user, approvalLine, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-200/60 flex items-center justify-center z-[100] p-4 print:p-0 print:bg-white print:static print:block">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh] print:max-w-none print:max-h-none print:shadow-none print:border-none print:block">
                ...
                <div className="p-12 overflow-auto bg-white print:p-0 print:overflow-visible" id="print-area">
...
const PrintSummaryModal = ({ employee, records, gen, used, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-200/60 flex items-center justify-center z-[100] p-4 print:p-0 print:bg-white print:static print:block">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] print:max-w-none print:max-h-none print:shadow-none print:border-none print:block">
                <div className="p-4 bg-slate-100 border-b flex justify-between items-center print:hidden">
...
const PrintPromotionModal = ({ allEmployees, records, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-200/60 flex items-center justify-center z-[100] p-4 print:p-0 print:bg-white print:static print:block">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col max-h-[95vh] print:max-w-none print:max-h-none print:shadow-none print:border-none print:block">
                <div className="p-4 bg-slate-100 border-b flex justify-between items-center print:hidden">
                    <h2 className="font-bold text-lg flex items-center gap-2"><Icons.List /> 전 직원 연차 집계 및 사용 촉진 (근로기준법 제61조)</h2>
                    <button onClick={onClose} className="text-slate-500 p-2 hover:bg-slate-200 rounded"><Icons.X /></button>
                </div>
                <div className="p-4 flex gap-4 h-full overflow-hidden print:block print:p-0 print:overflow-visible">
                    ...
                    <div className="flex-1 bg-white border rounded flex flex-col print:border-none print:block">
                        {!selectedEmp ? (
